...
const props = defineProps(["logoUrl", "userName"]);
...
<template>
    <main class="container-fluid p-0">
        <div class="row g-0 min-vh-100">
            <aside class="bg-body-tertiary col-2 vh-100">
                <div class="px-3 h-100 d-flex flex-column">
                    ...
                    <div class="flex-grow-1">
                        <div class="bg-white rounded-3 p-2 ps-2 mb-3">
                            <svg
            ...
            <article class="col-10">
                <div class="text-end pt-4 pb-3 px-5">
                    <Link href="/logout">
                        <i
                            class="fa-solid fa-arrow-right-from-bracket fs-4 text-secondary"
                        ></i>
                    </Link>
                </div>
                <hr class="p-0" />
